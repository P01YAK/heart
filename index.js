...
//change color building
var setTintNum = true
function setTintColor() {
	if (setTintNum) {
		setTintNum = false
		var setColor = 0x000003
	} else {
		setTintNum = true
...
//lights
var ambientLight = new THREE.AmbientLight(0xffffffff, 4)
var lightFront = new THREE.SpotLight(0xffffffff, 20, 10)
var lightBack = new THREE.PointLight(0xffffffff, 0.5)
...
//grid help
var gridHelper = new THREE.GridHelper(60, 120, 0x000003, 0x000003)

city.add(gridHelper)

//carss
var createCars = function (cScale = 2, cPos = 20, cColor = 0xdfffafdf) {
